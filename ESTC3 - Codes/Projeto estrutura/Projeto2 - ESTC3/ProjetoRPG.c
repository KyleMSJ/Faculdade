...
void define_geral()
{
	...
	Arma[2].ataque=30;
	Arma[2].peso=30;
	strcpy(Arma[3].nome,"Arco e flecha");
	Arma[3].ataque=35;
	Arma[3].peso=35;
...
printf("Caio Marcelo da Silva de Jesus - PC3011259\n\nJefferson Roberto Piaia Martines - PC3015602\n\n"
    ...
    printf("\n\n************Instrucoes basicas*************"
           ...
           " armazenados na mochila.\n    Caso queira usar um item adicionado anteriormente, tera que descartar o item antecessor."
           "\n    Tente sempre ficar com a arma mais forte."
