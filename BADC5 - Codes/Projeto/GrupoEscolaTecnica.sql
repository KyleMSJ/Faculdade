...
-- [10.1] ROW
--Esses gatilhos adicionarão uma unidade nos atributos "qtd_cursos_ministrados" da tabela professor e "qtd_cursos_possuidos" da tabela areatec.
...
-- Redigir pelo menos 1 comando SQL que dispare o gatilho em nivel de tupla
 -- Insere uma unidade nos atributos de contagem "qtd_cursos_ministrados" e "qtd_cursos_possuidos" 
...
-- [10.2] STATEMENT
-- Esse gatilho mantem consistente os atributos "qtd_cursos_ministrados" e "qtd_cursos_possuidos" , realizando uma contagem na tabela curso e inserindo o valor
-- da contagem nos atributos citados.
-- Redigir o comando CREATE OR REPLACE FUNCTION correspondente usando PL/pgSQL
--professor
...
-- Realiza a contagem pelo id_curso e insere o valor correspondente para cada professor e area tecnica nos atributos qtd_cursos_ministrados e qtd_cursos_possuidos.
...
('8','Técnico de Lubrificação Industial'),
...
('100', 'Administracao', '2022-08-01', '2022-10-30', '100', '1'),
('101', 'Comercio', '2022-07-01', '2022-10-30', '100', '1'),
('102', 'Comercio Exterior', '2022-07-01', '2022-10-30', '100', '1'),
('103', 'Contabilidade', '2022-07-01', '2022-10-30', '101', '1'),
('104', 'Gerencia em Saude', '2022-07-05', '2022-10-30', '101', '2'),
('105', 'Farmacia', '2022-07-05', '2022-10-30', '101', '2'),
('106', 'Enfermagem', '2022-07-05', '2022-10-30', '102', '2'),
('107', 'Anestesiologia', '2022-07-01', '2022-10-30', '102', '12'),
('108', 'Cirurgia plastica', '2022-07-01', '2022-07-30', '102', '12'),
('109', 'Geriatria', '2022-07-01', '2022-07-30', '103', '12'),
('110', 'Medicina da familia', '2022-07-01', '2022-08-30', '103', '12'),
...
('120', 'Alimentacao Escolar', '2022-06-25', '2022-06-30', '107', '19'),
...
('124', 'Arte Dramatica', '2022-06-25', '2022-06-30', '108', '7'),
('125', 'Artes Visuais', '2022-06-25', '2022-06-30', '108', '7'),
('126', 'Producao de Audio e Video', '2022-06-25', '2022-06-30', '108', '7'),
('127', 'Producao de Moda', '2022-06-25', '2022-06-30', '109', '7'),
('128', 'Publicidade', '2022-06-21', '2022-06-25', '109', '7'),
('129', 'Comunicacoes Aeronauticas', '2022-06-25', '2022-06-30', '110', '5'),
('130', 'Controle de Trafego Aereo', '2022-06-25', '2022-06-30', '110', '5'),
('131', 'Desenho Militar', '2022-06-25', '2022-06-25', '109', '5'),
('132', 'Desenho de Construcao Civil', '2022-06-25', '2022-06-30', '110', '4'),
('133', 'Edificacoes', '2022-06-25', '2022-06-30', '111', '4'),
...
('139', 'Analises Quimicas', '2022-06-25', '2022-06-30', '113', '20'),
('140', 'Eletroeletronica', '2022-06-25', '2022-06-30', '113', '20'),
('141', 'Eletromecanica', '2022-06-25', '2022-06-30', '114', '20'),
...
('153', 'Acucar e Alcool', '2022-06-25', '2022-06-30', '118', '9'),
('154', 'Biocombustiveis', '2022-06-25', '2022-06-30', '118', '9'),
('155', 'Ceramica', '2022-06-25', '2022-06-30', '118', '9'),
('156', 'Manutencao e Suporte em Informatica', '2022-06-25', '2022-06-30', '119', '11'),
('157', 'Telecomunicacoes', '2022-06-25', '2022-06-30', '119', '11'),
('158', 'Sistemas de Comutacao', '2022-06-25', '2022-06-30', '119', '11'),
('159', 'Sistemas de Transmissao', '2022-06-25', '2022-06-30', '119', '11'),
...
-- Enunciado: Faça uma consulta onde seja possível visualizar os nomes dos cursos que comecem antes ou em 30/06/2022, 
-- juntamente com a area tecnica e o professor responsável pelo mesmo.

-- Importancia na aplicacao: Mostra a área técnica a qual um curso pertence e o professor responsável pelo curso.
-- Usuario(s) atendido(s): superusuario, diretor, dbadm e professor 
...
-- Enunciado: Faça uma consulta que mostre a quantidade de cursos que professores com mais de 60 anos lecionam.

-- Importancia na aplicacao: Pode servir para visualizar professores idosos com alta carga de trabalho.
...
-- Enunciado: Crie uma visão onde seja possível visualizar os nomes dos cursos terminarão em 2022, 
-- juntamente com a area tecnica e o professor responsável pelo mesmo.

-- Importancia na aplicacao: Mostra todos os cursos a serem concluidos neste ano.
-- Usuario(s) atendido(s): superusuario, diretor e dbadm

create view vw.cursos_area_prof_2022 as 
select c.nome_curso, a.descricao, p.nome from tb.professor p 
inner join tb.curso c on p.id_prof = c.id_professor
inner join tb.areatec a on a.id_area = c.id_area where c.d_fim <= '2022-12-31' order by p.nome;


-- [5.2] Consulta na visao
-- Consultar a visao criada em 5.1 realizando filtro(s) (WHERE)
-- Enunciado: Selecione na visão anteriormente criada todos os cursos da area tecnica "Engenharia".
-- Importancia na aplicacao: Mostra todos os cursos da area de engenharia com final em 2022.
-- Usuario(s) atendido(s): superusuario, diretor e dbadm

select * from vw.cursos_area_prof_2022 where descricao = 'Engenharia';


-- [5.3] Visao materializada
-- A visao deve ter, no minimo, as caracteristicas de 4.2
-- Enunciado: Crie uma visão que mostre todos os professores com mais de 60 anos, e em quantos cursos eles lecionam.
-- Importancia na aplicacao: Pode servir para visualizar professores idosos com alta carga de trabalho.
-- Usuario(s) atendido(s): superusuario, diretor e dbadm
...
-- Enunciado: Selecione na visão anteriormente criada os professores que lecionam em mais de um curso.
-- Importancia na aplicacao: Mostra os professores idosos com alta carga de trabalho.
-- Usuario(s) atendido(s): superusuario, diretor e dbadm
...
-- Seria necessário atualizá-la sempre que fosse inserido um professor idoso.
...
RAISE NOTICE 'Foram adicionados 30 dias na data limite do curso de %', nomecurso;
...
-- essa chamada adicionara 30 dias na data limite do curso 'Comercio'
call prorroga_fim_curso('Comercio');
...
-- usuario dbadm conectando a partir do ip 10.128.70.215/32
-- host 		escolatecnica		dbadm		10.128.70.215/32		scram-sha-256

--usuario diretor conectando a partir do ip 10.128.70.220
-- host 		escolatecnica		diretor		10.128.70.220/32		scram-sha-256

--usuario professor conectando a partir do ip 10.178.70.225
-- host 		escolatecnica		professor		10.128.70.225/32		scram-sha-256
