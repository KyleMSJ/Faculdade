CREATE TABLE departamento (
	...
	CONSTRAINT numero_depto_nao_negativo CHECK (numero>0)
);
...
CREATE VIEW v_colaborador_horas(c_nome, t_horas) AS
SELECT c.nome, SUM(t.horas)
FROM colaborador c
LEFT JOIN trabalha_em t on c.cpf=t.cpf
GROUP BY c.cpf
ORDER BY c.nome ASC;

CREATE MATERIALIZED VIEW
mv_colaborador_horas(c_nome, t_horas) AS
SELECT c.nome, SUM(t.horas)
FROM colaborador c
LEFT JOIN trabalha_em t on c.cpf=t.cpf
GROUP BY c.cpf
...
UPDATE projeto SET nome='Avaina' WHERE numero=2;
INSERT INTO trabalha_em values ('678.809.888-08', 2014, 1);
INSERT INTO trabalha_em values ('452.321.741.58', 20, 12);
INSERT INTO trabalha_em values ('452.321.741.58', 2, 8);
INSERT INTO trabalha_em values ('377.422.456-34', 2, 15);
INSERT INTO trabalha_em values ('377.422.456-34', 1, 25);
INSERT INTO trabalha_em values ('858.045.579-05', 1, 25); 
INSERT INTO trabalha_em values ('858.045.579-05', 20, 25);