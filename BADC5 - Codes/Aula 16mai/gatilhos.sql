...
--
INSERT INTO trabalha_em (cpf, proj_num, horas) VALUES ('678.809.888-08', 1, 24);



ALTER TABLE dependente
    ADD CONSTRAINT dependente_pk PRIMARY KEY (cpf, nome);
...
-- dependente de colaboradora
INSERT INTO dependente (cpf, nome, sexo, datanasc, parentesco) VALUES ('888.666.555-55', 'K. Fernandes', 'M', '2019-03-29', 'Filho');



-- dependentes homonimas, colaboradoras distintas
INSERT INTO dependente (cpf, nome, sexo, datanasc, parentesco) VALUES ('888.666.555-55', 'Maria Alice', 'F', '2019-03-29', 'Filha');
INSERT INTO colaborador (nome, cpf, sexo, datanasc, logradouro, nro, salario, depto_num, supervisor_cpf) VALUES ('Odila Fernandes', '068.696.753-05', 'F', '1970-09-15', 'Alameda Vitória', '455', 8704.90, 777, NULL);
INSERT INTO dependente (cpf, nome, sexo, datanasc, parentesco) VALUES ('068.696.753-05', 'Maria Alice', 'F', '2010-03-01', 'Neta');

-- mais uma dependente Filha de colaboradora
INSERT INTO dependente (cpf, nome, sexo, datanasc, parentesco) VALUES ('888.666.555-55', 'Maria Tereza', 'F', '2013-11-09', 'Filha');

-- atualizando atributo derivado
