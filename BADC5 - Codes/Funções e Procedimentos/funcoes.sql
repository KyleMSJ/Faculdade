CREATE TABLE departamento (
	...
	qtde_empregados SMALLINT DEFAULT 0,
	CONSTRAINT qtde_empregados_nao_negativa CHECK (qtde_empregados>=0)
);
...
-- dependente homonima (parentesco diferente)
INSERT INTO dependente (cpf, nome, sexo, datanasc, parentesco) VALUES ('888.666.555-55', 'Maria Alice', 'M', '2019-03-29', 'Mae');
