...
BEGIN
	...
	LOOP
		-- mostrando uma notificação na linha de saída (uma forma de monitoramento do código)
		RAISE NOTICE '% % da colaboradora %', var_dependente.nome, um_parentesco, var_dependente.cpf;
